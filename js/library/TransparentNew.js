...
const LuminosityHighPassShader = {
  ...
  fragmentShader: /* glsl */ `
        ...
        void main() {
            ...
            float alpha = smoothstep( luminosityThreshold + smoothWidth, luminosityThreshold, v );
...
import "https://cdn.jsdelivr.net/npm/three@0.132.2/examples/js/postprocessing/Pass.js";

class TransparentBackgroundFixedUnrealBloomPass extends THREE.Pass {
  ...
  getSeperableBlurMaterial(kernelRadius) {
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: `#include <common>
          ...
          gl_FragColor = vec4(diffuseSum/weightSum, 0.2);\n\
        }`,
    });
  }
...
TransparentBackgroundFixedUnrealBloomPass.BlurDirectionX = new THREE.Vector2(
  1.0,
  0.0
);
TransparentBackgroundFixedUnrealBloomPass.BlurDirectionY = new THREE.Vector2(
  0.0,
  1.0
);
export let test1 = TransparentBackgroundFixedUnrealBloomPass;
